...
| 时间顺序 | 处理 | 内容 |
|---------|-----|------|
| 1 | C->B 多种协议 | 控制器尝试在pos位置放置TNT方块 |
| 3 | B->S spp协议 | 客户端client尝试放置TNT方块到某位置 |
| 4 | S | 反作弊、权限等系统计算并处理，发现客户端可以放置这个TNT方块 |
| 5 | S->B spp协议 | 发送TNT方块放置数据报 |
| 6 | B->C 多种协议 | 给可以看见方块[1]的玩家发送TNT方块放置数据报 |
